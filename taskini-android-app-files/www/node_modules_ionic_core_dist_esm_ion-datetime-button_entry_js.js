...
const DatetimeButton = class {
  constructor(hostRef) {
     ...
     */
    this.waitForDatetimeChanges = /*#__PURE__*/(0,_srv_appery_jenkins_workspace_0b7d2f0c_652d_41ca_bbff_8aebd79708d1_android_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
      if (!datetimeEl) {
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,_srv_appery_jenkins_workspace_0b7d2f0c_652d_41ca_bbff_8aebd79708d1_android_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
        if (!overlayEl) {
